import { ArrowUpRight, BarChart3, Coins, Layers, LineChart, ReceiptText, Sparkles, Target, User, Wallet } from 'lucide-react'
...
const tabMeta = {
  ...
  bi: {
    ...
    title: 'Turn finance data into decisions',
    copy: 'View KPIs, category shares, budget performance, trend movement, and top spending in one BI report.',
    accent: '#38bdf8'
  },
  budgets: {
    icon: Target,
